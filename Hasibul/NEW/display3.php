    ...
    //echo "Connected successfully\n";
        ...
        if ($result->num_rows > 0) 
        {
            while ($row = $result->fetch_assoc()) 
            {
                ...
                <td id='b".$row['Id']."'>".$row['Date']."</td>;
                <td Id='c".$row['Id']."'>".$row['Type']."</td>
                <td Id='d".$row['Id']."'>".$row['Price']."</td>
                <td Id='e".$row['Id']."'>".$row['Vat']."</td>
                <td Id='f".$row['Id']."'>".$row['Total_Cost']."</td>";
                ...
                if(isset($_GET[$row['Id']])){
                    ...
                    echo "</br></br>";
                    echo "Type: <input type='text' name='Type' value=".$row['Type'].">";
                    echo "</br></br>";
                    echo "Price: <input type='text' name='Price' value=".$row['Price'].">";
                    echo "</br></br>";
                    echo "Vat: <input type='text' name='Vat' value=".$row['Vat'].">";
                    echo "Total_Cost: <input type='text' name='Total_Cost' value=".$row['Total_Cost'].">";
                    echo "</br></br>";
                    echo "</br></br>";
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $ssql = "UPDATE `payment` SET Id='$Id', Date='$Date', Type='$Type',Price='$Price', Vat='$Vat',Total_Cost='$Total_Cost'
                        WHERE Id=".$row['Id']."";
                ...
                if(isset($_GET['delete'.$row['Id']])){
                    $delete = "DELETE FROM `payment` WHERE Id=".$row['Id']."";
