    ...
    //echo "Connected successfully\n";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <td id='b".$row['Id']."'>".$row['Model']."</td>;
                <td Id='c".$row['Id']."'>".$row['Company']."</td>
                <td Id='d".$row['Id']."'>".$row['Description']."</td>";
                ...
                if(isset($_GET[$row['Id']])){
                    ...
                    echo "</br></br>";
                    echo "Company: <input type='text' name='Company' value=".$row['Company'].">";
                    echo "</br></br>";
                    ...
                    if(isset($_POST['submit'])){
                       ...
                       $ssql = "UPDATE `bike` SET Id='$Id', Model='$Model', Company='$Company', Description='$Description'
                        WHERE Id=".$row['Id']."";
                ...
                if(isset($_GET['delete'.$row['Id']])){
                    $delete = "DELETE FROM `bike` WHERE Id=".$row['Id']."";
